...
class AudioStreamer:
    ...
    def __init__(self, stream_manager, input_device_index=None, output_device_index=None):
        ...
        debug_print(f"Opening input audio stream with device index: {self.input_device_index}...")
        ...
        debug_print(f"Opening output audio stream with device index: {self.output_device_index}...")
...
async def main(debug=False):
    ...
    stream_manager = BedrockStreamManager(model_id='amazon.nova-sonic-v1:0', region='us-east-1', voice_id='matthew')
